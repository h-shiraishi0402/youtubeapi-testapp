...
class Page2ViewController: UITableViewController, SegementSlideContentScrollViewDelegate {
    ...
    func getData(){
        ...
        let text = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyA_XlXfP3DkcnhMnSnUhqPm9LwO9w5C-ww&q=笑ってはいけない&part=snippet&maxResults=40&order=date"
        ...
        AF.request(url, method: .get, parameters: nil, encoding: JSONEncoding.default).responseJSON {(respond) in
            ...
            case .success :
                for i in 0...20 - 1{
                    ...
                    let imageURLString = json["items"][i]["snippet"]["publishedAt"]["thumbnails"]["default"]["url"].string
